"""Prepare deterministic split artifacts.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Prepare dataset split artifacts.")
    parser.add_argument("--config", default=DEFAULT_CONFIG_PATH, help="Path to YAML config.")
    return parser.parse_args()


def main() -> None:
    """Create or reuse a deterministic split artifact.
    ...
    # Printing basic metadata about the splits.
    split_groups = 0
