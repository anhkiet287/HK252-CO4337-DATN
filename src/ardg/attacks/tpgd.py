...
def build_tpgd_attack(cfg: Dict[str, Any], model: "nn.Module") -> Any:
    """Build a TPGD attack via TorchAttacks."""
    ...
    if norm_name not in {"linf", "inf"}:
        raise ValueError(f"Unsupported TPGD norm: {norm_name!r}. Use 'Linf'.")
