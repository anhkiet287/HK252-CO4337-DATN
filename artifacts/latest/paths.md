...
### eval
- `run_name`: `resnet18_dev_baseline_erm_seed42_eval`
- `run_dir`: `/workspaces/HK252-CO4337-DATN/outputs/dev_fast/resnet18_dev_baseline_erm_seed42_eval`
- `resolved_config`: `/workspaces/HK252-CO4337-DATN/outputs/dev_fast/resnet18_dev_baseline_erm_seed42_eval/resolved_config.yaml`
- `run_manifest`: `/workspaces/HK252-CO4337-DATN/outputs/dev_fast/resnet18_dev_baseline_erm_seed42_eval/run_manifest.json`
- `config_path`: `/workspaces/HK252-CO4337-DATN/configs/experiments/cifar10/resnet18/eval/baseline_erm_all_attacks.yaml`
- `profile_path`: `/workspaces/HK252-CO4337-DATN/configs/profiles/dev_fast.yaml`
- `wandb_run_id`: `ix6e2uor`
- `checkpoint`: `outputs/dev_fast/resnet18_dev_baseline_erm_seed42/checkpoints/best.pt`
- `summary_json`: `/workspaces/HK252-CO4337-DATN/outputs/dev_fast/resnet18_dev_baseline_erm_seed42_eval/eval/summary.json`
