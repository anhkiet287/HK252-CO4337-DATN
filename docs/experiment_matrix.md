...
| ResNet-50 | Proposed | `configs/experiments/cifar10/resnet50/proposed/groupdro_plus.yaml` | `h100` | Scale-up proposed method |
...
| ViT-B/16 | Proposed | `configs/experiments/cifar10/vit_b16/proposed/groupdro_plus.yaml` | `h100` | Optional extension proposed method |
